...
import { LocalizedComponent } from 'app/entities/bonContentService/localized/localized.component';
...
describe('Component Tests', () => {
  describe('Localized Management Component', () => {
    let comp: LocalizedComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocalizedComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.localizeds && comp.localizeds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
