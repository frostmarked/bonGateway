...
import { FragmentComponent } from 'app/entities/bonContentService/fragment/fragment.component';
...
describe('Component Tests', () => {
  describe('Fragment Management Component', () => {
    let comp: FragmentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FragmentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fragments && comp.fragments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
