...
import com.bonlimousin.gateway.client.bonlivestockservice.apidocs.model.PublishResult;
import com.bonlimousin.gateway.client.bonlivestockservice.apidocs.model.SseEmitter;
...
@Validated
@Api(value = "BonLivestockServiceKafkaResource", description = "the BonLivestockServiceKafkaResource API")
public interface BonLivestockServiceKafkaResourceApi {

    /**
     * GET /api/bon-livestock-service-kafka/consume : consume
     *
     ...
     */
    @ApiOperation(value = "consume", nickname = "consumeUsingGET", notes = "", response = SseEmitter.class, tags={ "bon-livestock-service-kafka-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = SseEmitter.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/bon-livestock-service-kafka/consume",
        produces = "*/*", 
    ...
    /**
     * POST /api/bon-livestock-service-kafka/publish/{topic} : publish
     *
     ...
     *         or Not Found (status code 404)
     */
    @ApiOperation(value = "publish", nickname = "publishUsingPOST", notes = "", response = PublishResult.class, tags={ "bon-livestock-service-kafka-resource", })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/bon-livestock-service-kafka/publish/{topic}",
        produces = "*/*", 
