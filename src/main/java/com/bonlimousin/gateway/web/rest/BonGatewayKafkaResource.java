...
@RestController
@RequestMapping("/api/bon-gateway-kafka")
public class BonGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BonGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BonGatewayKafkaResource(KafkaProperties kafkaProperties) {
