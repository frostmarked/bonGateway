...
public class CacheConfiguration {
    ...
    public static final String CACHE_COW_PICTURES = "cowpictures";
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bonGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bonGateway");
        ...
        config.getMapConfigs().put("com.bonlimousin.gateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
