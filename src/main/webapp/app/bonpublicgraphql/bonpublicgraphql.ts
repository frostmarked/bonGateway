...
export type FindCowPhotosQuery = (
  { __typename?: 'Query' }
  & { apiPublicCowsPhotographs?: Maybe<Array<Maybe<(
    { __typename?: 'PhotographVO' }
    & Pick<PhotographVo, 'caption' | 'earTagId' | 'height' | 'id' | 'image' | 'imageContentType' | 'taken' | 'visibility' | 'width'>
  )>>> }
);
