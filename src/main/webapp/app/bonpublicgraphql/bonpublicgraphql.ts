...
export type Query = {
   ...
   */
  apiPublicCowPhotographs?: Maybe<Array<Maybe<PhotographVo>>>;
  /**
...
export type QueryApiPublicCowPhotographsArgs = {
...
export const FindCowPhotosDocument = gql`
  query FindCowPhotos($earTagId: Float!, $page: Int, $size: Int, $sort: [String], $excludeImage: Boolean = false) {
    apiPublicCowPhotographs(earTagId: $earTagId, page: $page, size: $size, sort: $sort) {
      caption
      earTagId
      height
      id
